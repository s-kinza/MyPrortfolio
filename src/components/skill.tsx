      ...
      <section className="text-gray-100 body-font bg-gray-900">
        <div className="container px-5 py-16 md:py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-10 md:mb-20">
            <h2 className="text-indigo-500 tracking-widest font-bold title-font mb-1 text-lg md:text-xl">
              Skills
            </h2>
            <h1 className="text-2xl sm:text-3xl font-extrabold title-font text-gray-200">
              My Skills
            </h1>
          </div>
          <div className="flex flex-wrap -m-4">
            {/* Skill Card */}
            <SkillCard name="HTML" progress="100%" width="w-full" />
            <SkillCard name="CSS" progress="70%" width="w-[70%]" />
            <SkillCard name="JavaScript/TypeScript" progress="50%" width="w-[50%]" />
            <SkillCard name="React.JS" progress="60%" width="w-[60%]" />
            <SkillCard name="Next.js" progress="80%" width="w-[80%]" />
            <SkillCard name="Tailwind CSS" progress="75%" width="w-[75%]" />
            <SkillCard name="Canva" progress="55%" width="w-[55%]" />
          </div>
        </div>
      </section>
    </div>
...
const SkillCard = ({ name, progress, width }) => (
  <div className="p-4 sm:w-1/2 md:w-1/3 lg:w-1/4">
    <div className="flex rounded-lg h-full p-6 md:p-8 flex-col">
      <div className="flex items-center mb-3">
        <div className="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full bg-indigo-500 text-white flex-shrink-0">
          <PiFlagCheckeredFill className="text-lg md:text-xl font-bold" />
        </div>
        <h2 className="text-gray-200 text-md md:text-lg title-font font-extrabold">
          {name}
        </h2>
      </div>
      <div className="flex-grow">
        <div className="relative h-8 w-full bg-gray-300 rounded-full">
          <div className={`absolute inset-0 ${width} bg-indigo-500 rounded-full`}></div>
        </div>
        <p className="text-indigo-500 font-bold text-right mt-2">{progress}</p>
      </div>
    </div>
  </div>
);
